...
import { getAdminProjectAndpro } from "../services/auth";
...
const PendingApprovalPlans: React.FC = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      setLoading(true);
      try {
        const response = await getAdminProjectAndpro();
...
export default PendingApprovalPlans;
